<?php
    ...
    class Controller {
        ...
        public static function removeFormatacaoNumero($strNumero)
        {
        ...
        public static function converte($valor = 0, $bolExibirMoeda = true)
        {
            $valor = self::removeFormatacaoNumero($valor);

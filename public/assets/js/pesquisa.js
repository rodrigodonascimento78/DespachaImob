                                ...
                                <form method="POST" action="http://despachaimob.com/editaimovel" class="viacepForm">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="iptu" id="iptu" class="form-control pula" value="`+ result[0][0].iptu +`" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="banheiros" id="banheiros" class="form-control pula" value="`+ result[0][0].banheiros +`">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="dce" class="mb-0 col-form-label-sm">DCE</label>
                                            <input type="text" name="dce" id="dce" class="form-control pula" value="`+ result[0][0].dce +`">
                                        </div>                    
                                    </div><!-- Row 5 -->
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="varanda" id="varanda" class="form-control pula" value="`+ result[0][0].varanda +`">
                                        </div>
                                        <div class="form-group col-md-2">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="ap_andar" id="ap_andar" class="form-control pula" value="`+ result[0][0].ap_andar +`">
                                        </div>
                                    </div><!-- Row 6 -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="area" id="area" class="form-control pula" value="`+ result[0][0].area +`">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="apto_posicao" class="mb-0 col-form-label-sm">Posicão Apto</label>
                                            <input type="text" name="apto_posicao" id="apto_posicao" class="form-control pula" value="`+ result[0][0].apto_posicao +`">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="sol_posicao" class="mb-0 col-form-label-sm">Psição Sol</label>
                                            <input type="text" name="sol_posicao" id="sol_posicao" class="form-control pula" value="`+ result[0][0].sol_posicao +`">
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="sindico" id="sindico" class="form-control pula" value="`+ result[0][0].sindico +`">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="s_telefone" class="mb-0 col-form-label-sm">Telefone</label>
                                            <input type="text" name="s_telefone" id="s_telefone" class="form-control pula" value="`+ result[0][0].s_telefone +`">
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label for="s_email" class="mb-0 col-form-label-sm">E-mail</label>
                                            <input type="text" name="s_email" id="s_email" class="form-control pula" value="`+ result[0][0].s_email +`">
                                        </div>
                                    </div><!-- Row 9 -->
                                    <div class="row">
                                        <div class="form-group col-md-12">
